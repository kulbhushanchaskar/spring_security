...
import com.oauth.login.model.AuthProvider;
import com.oauth.login.model.User;
import com.oauth.login.security.UserPrincipal;
import com.oauth.login.security.oauth2.user.OAuth2UserInfo;
import com.oauth.login.security.oauth2.user.OAuth2UserInfoFactory;
    ...
    private ClientRegistration getRegistration(String client) {
        ...
        if (client.equals("google")) {
            return CommonOAuth2Provider.GOOGLE.getBuilder(client)
              .clientId("235888787735-kekrrolohivf6fb6i0danm67mjkh1233.apps.googleusercontent.com")
              .clientSecret("eMDUyoHAehMWaRhu0FFP3_67").build();
        }
        return null;
    }*/
